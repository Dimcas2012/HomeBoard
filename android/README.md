...
5. AI: у кабінеті **AI** увімкніть аналітику для камери. Опція «on-device» грузить легку модель у WebView і шле кадр лише коли є цікавий клас.
